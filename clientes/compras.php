...
<body data-bs-theme="light">
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<h1 class="hCompras">Artículos que puedes comprar</h1>
				<p class="pCompras">Encontraras diversos tipos de tarimas que se pueden ajustar a tus necesidades.</p>
				<p class="pCompras">Los precios de los artículos unicamente tienen este costo para consumidores que no compran al mayoreo, si necesitas una cantidad grande de productos realiza una <a class="link pCompras" href="../clientes/cotizar.php">cotización.</a></p>
				<br>
				...
				<table class="table  table-hover table-responsive">
					...
					<tr>
						<td class="registros h6"><?php echo $fila['idArticulo'] ?></td>
						<td class="registros h6"><?php echo $fila['modelo'] ?></td>
						<td class="registros h6"><?php echo $fila['material'] ?></td>
						<td><img style="width: 200px;" src="data:image/jpg;base64,<?php echo base64_encode($fila['imagen']) ?>" alt=""></td>
						<td class="registros h6"><?php echo '$ '.$fila['precio'] ?></td>
					</tr>
