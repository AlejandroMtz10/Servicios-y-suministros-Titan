            ...
            <ul>
                ...
                <div class="card">
                    <div class="card-header h4">
                        <?php echo 'Folio de entrega: '.$entrega['idEntrega']; ?>
                    </div>
                    <div class="card-body">
                        <h5 class="card-title"><?php echo 'Folio de registro en la agenda: '.$entrega['idRegistro']; ?>
                        </h5>
                        <h5 class="card-title"><?php echo 'Empresa: '.$entrega['empresa']; ?></h5>
                        <p class="card-text"><?php echo 'Entregada por: '.$entrega['entregadaPor']; ?></p>
                        <a href="../crudEntregas/eliminarEntrega.php?id=<?php echo $entrega["idEntrega"] ?>"
                            class="btn btn-outline-danger btnEliminar"><i class="bi bi-trash"></i> Eliminar</a>
                    </div>
                </div>
                <br>
                <?php endforeach; ?>
