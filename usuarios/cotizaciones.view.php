				...
				<?php foreach ($cotizaciones as $cotizacion):?>	
					<div class="card">
		  				<div class="card-header h4">
		    				<?php echo 'Número de cotización: '.$cotizacion['idCotizacion']; ?>
		  				</div>
		  				<div class="card-body">
		    				<h5 class="card-title"><?php echo 'Nombre: '.$cotizacion['nombre']; ?></h5>
		    				<h5 class="card-title"><?php echo 'Empresa: '.$cotizacion['empresa']; ?></h5>
		    				<p class="card-text"><?php echo 'Fecha: '.$cotizacion['fecha']; ?></p>
		    				<p class="card-text"><?php echo 'Número telefonico: '.$cotizacion['numeroTelefonico']; ?></p>
		    				<p class="card-text"><?php echo 'Correo electronico: '.$cotizacion['email']; ?></p>
		    				<p class="card-text"><?php echo 'Cantidad de tarimas: '.$cotizacion['cantidadTar']; ?></p>
		    				<p class="card-text"><?php echo 'Caracteristicas: '.$cotizacion['caracteristicas']; ?></p>
		    				<a href="../crudCotizaciones/eliminarCotizacion.php?id=<?php echo $cotizacion["idCotizacion"] ?>" class="btn btn-outline-danger btnEliminar"><i class="bi bi-trash"></i> Eliminar</a>
		  				</div>
					</div>
				<?php endforeach; ?>	
			</ul>
