...
<body data-bs-theme="light">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col">
                <h1 class="hCompras">Productos a la venta.</h1>
                <br>
                <a href="../usuarios/registrarProducto.php" class="btn btn-outline-success registro"><i
                        class="bi bi-plus-square"></i> Nuevo producto</a>
            </div>
        </div>
        <div class="row">
            <div class="col">
                ...
                <table class="table  table-hover table-responsive">
                    ...
                    <tr>
                        <td class="registro"><?php echo $fila['idArticulo'] ?></td>
                        <td class="registro"><?php echo $fila['modelo'] ?></td>
                        <td class="registro"><?php echo $fila['material'] ?></td>
                        ...
                        <td>
                            <button class="btn btn-secondary opciones" data-bs-toggle="modal"
                                data-bs-target="#modal-foto<?php echo $fila['idArticulo']; ?>"><i
                                    class="bi bi-images"></i>
                                Nueva imagen</button>
							
                            <a href="../usuarios/editarProducto.php?idProductoEdit=<?php echo $fila['idArticulo']; ?>"
                                class="btn btn-warning opciones"><i class="bi bi-pencil-square"></i> Editar</a>
							
                            <a href="../crudArticulos/eliminarArticulo.php?id=<?php echo $fila["idArticulo"] ?>"
                                class="btn btn-danger opciones">Eliminar</a>
                        </td>
                    </tr>


                    <div class="modal fade" id="modal-foto<?php echo $fila['idArticulo']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <form action="../crudArticulos/nuevaImagenArticulo.php?idEditar=<?php echo $fila["idArticulo"]; ?>"
