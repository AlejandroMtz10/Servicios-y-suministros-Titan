...
<body data-bs-theme="light">
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<h1 class="hRegistros">Registrar artículo</h1>
				<p class="pRegistros">Registrar los articulos que estan a la venta, por favor llena todos los campos.</p>
			</div>
			<br>


		<form action="../crudArticulos/insertArticulo.php" method="POST" enctype="multipart/form-data" class="row g-3 mt3">
			<div class="col-12">
				<label for="modeloInput" class="form-label lblModelo">Modelo: * </label>
				<input type="text" class="form-control inputArticulos" id="modeloInput" placeholder="Modelo del artículo" name="modeloArt">
			</div>

			<div class="col-12">
				<label for="materialInput" class="form-label lblMaterial">Material: * </label>
				<input type="text" class="form-control inputArticulos" id="materialInput" placeholder="Material" name="materialArt">
			</div>

			<div class="col-8">
				<label for="imagenInput" class="form-label lblImagen">Imagen: * </label>
				<input type="file" class="form-control inputArticulos" id="imagenInput" placeholder="Imagen del artículo" name="imagenArt">
			</div>
			...
			<div class="col-12">
				...
				<input type="number" min="0" class="form-control inputArticulos" id="precioInput" placeholder="Precio del artículo" name="precioArt">
			</div>


			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="../usuarios/registrarProducto.php" class="btn btn-outline-danger btnCancelar">Cancelar</a>
                 <input type="submit" name="enviarImagen" value="Guardar" class="btn btn-outline-success btnGuardar">
				 <a href="../usuarios/productosRegistrados.php" class="btn btn-outline-warning btnProductos">Productos</a>  
			</div>
		</form>
	    </div>
    </div>                 
